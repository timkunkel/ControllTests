...
import de.tim.controlltest.SimpleGestureDetector.DirectionListener;

public class ControllTest implements ApplicationListener {
	...
	public void create() {		
		...
		Gdx.input.setInputProcessor(new SimpleGestureDetector(new SimpleGestureDetector.DirectionListener() {
			...
			public void onRight() {
				// TODO Auto-generated method stub
				sprite.setPosition(0, -sprite.getWidth()/2);
			...
			public void onLeft() {
				// TODO Auto-generated method stub
				sprite.setPosition(-sprite.getWidth(), -sprite.getWidth()/2);
